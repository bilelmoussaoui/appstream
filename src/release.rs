...
pub struct Release {
    ...
    #[serde(deserialize_with = "timestamp_deserialize", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, deserialize_with = "artifacts_deserialize", skip_serializing_if = "Vec::is_empty")]
